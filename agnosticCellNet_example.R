...
save(xpairs_list,
     file = "example_outputs/Hs_xpairs_list.rda")
...
# png(file = "example_outputs/heatmapLiverRef.png",
#     height = 12,
#     width = 9,
#     units = "in",
#     res = 300)
...
save(classMatrixQuery,
     file = "example_outputs/example_classificationMatrix.rda")
...
save(GRN_statusQuery,
     file = "example_outputs/my_study_GRN_status.rda")
...
pdf(file = "example_outputs/my_study_GRN_status_plots.pdf",
    height = 8,
    width = pdf_width)
plot_list <- list()
...
save(TF_scores,
     file = "example_outputs/my_study_TF_scores.rda")
...
# pdf(file = "example_outputs/my_study_TF_scores_my_cell_type.pdf",
#     height = 6,
#     width = 8)
